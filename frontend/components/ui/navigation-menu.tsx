...
>(({ children, className, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 max-w-max flex-column items-center justify-left my-0",
      className
    )}
    {...props}
  >
